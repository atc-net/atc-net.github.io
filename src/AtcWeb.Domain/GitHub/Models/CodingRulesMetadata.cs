...
namespace AtcWeb.Domain.GitHub.Models
{
    ...
    {
        public static Version LatestVersionRoot => new Version(1, 0, 7);

        public static Version LatestVersionSrc => new Version(1, 0, 5);

        public static Version LatestVersionTest => new Version(1, 0, 7);
