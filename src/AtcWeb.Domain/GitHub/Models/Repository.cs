...
namespace AtcWeb.Domain.GitHub.Models
{
    public class Repository
    {
        public Repository(GitHubRepository gitHubRepository)
        {
            ...
            FoldersAndFiles = new DirectoryMetadata();
        ...
        public DirectoryMetadata FoldersAndFiles { get; set; }
        ...
        ////    return InvokeLoad(gitHubApiClient, gitHubRawClient, cancellationToken);
        ////}
        ...
        ////    ////FoldersAndFiles = GitHubRepositoryHelper.GetFoldersAndFiles(gitHubApiClient);
        ////    ////Root = await GitHubRepositoryMetadataHelper.LoadRoot(gitHubApiClient, gitHubRawClient, BaseData.Name, DefaultBranchName, cancellationToken);
        ////    ////Workflow = await GitHubRepositoryMetadataHelper.LoadWorkflow(gitHubRawClient, Root, BaseData.Name, DefaultBranchName, cancellationToken);
        ////    ////CodingRules = await GitHubRepositoryMetadataHelper.LoadCodingRules(gitHubRawClient, Root, BaseData.Name, DefaultBranchName, cancellationToken);
        ////    ////Dotnet = await GitHubRepositoryMetadataHelper.LoadDotnet(gitHubRawClient, Root, BaseData.Name, DefaultBranchName, cancellationToken);
